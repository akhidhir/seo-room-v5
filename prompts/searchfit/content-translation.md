...
The page content, meta tags and structure are already provided to you in the crawl payload — you cannot browse or fetch the site yourself. Work from the supplied content. Where target-market keyword data isn't in the payload, say so and mark those keywords as requiring live research.
...
- Identify what people actually search for in the target language, using the keyword data supplied in the payload
- Use localized keyword data or SERP data where provided
