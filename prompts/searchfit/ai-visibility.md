...
Infer the following from the crawl data and project context provided. Do not ask questions — state your assumptions explicitly where the data is thin:
...
Assess how the brand is likely to appear, based on the crawl payload and any AI-search / mention data supplied. You cannot browse or query AI platforms live — reason from the provided data and flag where live testing would be needed.
