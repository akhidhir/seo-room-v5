...
Infer the following from the crawl data and project context provided. Do not ask questions — state your assumptions explicitly:
...
The page's content, meta tags, headings, images, links and schema are already provided in the crawl payload — you cannot fetch or browse the page yourself. Evaluate from that payload:
