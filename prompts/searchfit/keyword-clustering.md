...
The keyword list is already provided in the payload. Do not ask for it. It may arrive as:
- A list of keywords with volume/difficulty data
- Seed keywords to expand from
- Keywords extracted from the site's existing content in the crawl payload

Work with whatever is supplied and state which source you used.
